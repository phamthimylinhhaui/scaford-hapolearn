<div class="container feedback">
    <div class="feedback-top">
        ...
        <div class="feedback-description">What other students turned professionals have to say about us after learning with us
        ...
        <div class="slide-show">
            <div class="feedback-item ">
                    ...
                    <div class="row user-comment">
                        <img src="{{ asset('images/image-user.png') }}" class="col-2" alt="...">
                        <div class="feedback-user-info col-8">
                            <div class="user-avatar">Hoang Anh Nguyen</div>
